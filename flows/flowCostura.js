...
const {flowInfoV} = require('./flowAlmacen.js')





 const flowCostura = addKeyword(['3']).addAnswer(
    ['*🕛 HORARIOS*',
    '  Nuestros horarios son: ',
    '▫️ Lunes a Viernes de *9:00 am a 6:00 pm*',
    '▫️ Sábados *8:30 am a 12:30 pm*'
],{media:'https://drive.google.com/uc?id=10Po9YLYF0a_NP2BmNgBkfddaMyv3jrs_',delay:1500},async (ctx,{flowDynamic,provider})=>{
...
.addAnswer(
    ...
    //    const flowInfoC = addKeyword(['0'])
    //    .addAnswer('Seleciona la vacante de tu interes')
    //    .addAnswer('1️⃣ Auxiliar de Almacen General')
       
    //    .addAnswer(['3️⃣ Costureros & Confección de Cortinas'],
    //    null,
    //    null,
    //    [flowDescargas,flowAlmacen])
