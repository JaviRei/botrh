...
class AudioNative {
    ...
    create(file, request, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                ...
                method: "POST",
                headers: {
                    "xi-api-key": (yield core.Supplier.get(this._options.xiApiKey)) != null
                        ? yield core.Supplier.get(this._options.xiApiKey)
                        : undefined,
     ...
     * @throws {@link ElevenLabs.UnprocessableEntityError}
     */
    getEmbedCode(requestOptions) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.ElevenLabsEnvironment.Production, "v1/audio-native/get-embed-code"),
                method: "GET",
                headers: {
                    "xi-api-key": (yield core.Supplier.get(this._options.xiApiKey)) != null
                        ? yield core.Supplier.get(this._options.xiApiKey)
     ...
     * @throws {@link ElevenLabs.UnprocessableEntityError}
     */
    getProjectEmbedCode(projectId, requestOptions) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.ElevenLabsEnvironment.Production, `v1/audio-native/${projectId}/get-embed-code`),
                method: "GET",
                headers: {
                    "xi-api-key": (yield core.Supplier.get(this._options.xiApiKey)) != null
                        ? yield core.Supplier.get(this._options.xiApiKey)
